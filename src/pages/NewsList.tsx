...
import { Calendar, ArrowRight, ExternalLink, Home } from "lucide-react"
...
export default function NewsList() {
  ...
  const newsItems = [
    ...
    // },
    // {
    //   id: "wellness-programs-expansion",
    //   title: "Health & Fitness Centers Expand Wellness Programs",
    //   excerpt: "Introduction of holistic wellness programs combining physical fitness, mental health, and nutritional guidance.",
    //   date: "2024-02-28",
  ...
  return (
    <div className="min-h-screen matte-bg">
      ...
      <main className="pt-16">
        <section className="section-enhanced bg-muted/30" ref={scrollRef}>
          <div className="container mx-auto px-4">
            ...
            {newsItems.filter(item => item.featured).map((item) => (
              <Link key={item.id} to={`/news/${item.id}`} className="block mb-16 scroll-fade-in">
                <Card className="glossy overflow-hidden group hover-lift cursor-pointer hover:shadow-elegant transition-all duration-300 border-2 border-primary/20 bg-gradient-to-r from-primary/5 to-accent/5">
                  <div className="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div className="p-8 lg:p-12 flex flex-col justify-center">
                      ...
                      <h2 className="text-3xl lg:text-4xl font-bold mb-6 group-hover:text-primary transition-colors duration-300 leading-tight">
                        {item.title}
                      </h2>
